...
def read_transactions(tuali_cliente_id: str):
...
def read_inventory(tuali_cliente_id: str):
...
def read_daily_sales(tuali_cliente_id: str):
...
def read_daily_products(tuali_cliente_id: str):
...
def read_growth_context(tuali_cliente_id: str):
